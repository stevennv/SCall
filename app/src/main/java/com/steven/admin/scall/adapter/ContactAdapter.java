package com.steven.admin.scall.adapter;
...
import com.steven.admin.scall.activity.EditNameActivity;
...
import com.steven.admin.scall.utils.Utils;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        myViewHolder.llItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    InfoStyle infoStyle = db.getStyleByPhone(phoneFormat);
